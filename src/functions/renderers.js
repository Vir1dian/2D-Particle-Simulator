...
const particleElementFunctions = {
    ...
    createParticle(mass = simulation_settings.mass, radius = simulation_settings.radius, position = simulation_settings.position, velocity = simulation_settings.velocity, acceleration = simulation_settings.acceleration, oscillation = simulation_settings.oscillation, color = simulation_settings.color) {
